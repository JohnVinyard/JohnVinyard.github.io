...
hand-labelled audio dataset to get started.
...
since we can't optimize this term over all $N$ triplets, we'll optimize 
...
some practice scraping audio and attendant metadata from  disparate sources on 
...
text search?
- Is it possible to further embed or representations in a two or 
three-dimensional space, making navigation visual and intuitive (our t-SNE 
visualization above points to "yes")?
